...
@Component({
  selector: 'app-root',
  imports: [RouterOutlet, TwoWayBinding, ViewChildAndRenderer2WithElementRef, 
    EventBinding, ViewChildrenQuerylistElementref, ReactiveFormsFormControlFormGroup, RouterLink],
